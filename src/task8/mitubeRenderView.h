...
//  @April. 26th
//		.before synchronizing interactions, calibrate mouse positions so that
//		the mouse movement and clicks can lead to exactly same operation for
//		each sub views
//		The way: scaling according to the bounding box of each view's object
//
